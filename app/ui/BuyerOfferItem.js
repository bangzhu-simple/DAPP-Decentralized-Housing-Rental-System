...
<div class="media bg-light p-3">
  ...
  <div class="media-body">
    ...
    <div class="mb-1">{{data.listing.seller}}</div>
    <div class="btn-toolbar mt-3">
      <div class="btn-group mr-3">
        <button class="btn btn-secondary btn-sm" @click="cancelOffer" :disabled="data.status!=1">取消</button>
      </div>

      <div class="btn-group mr-3">
        <button class="btn btn-secondary btn-sm" @click="finalizeOffer":disabled="data.status!=2">支付订单</button>
      </div>
